...
<!--2017-->
- 石川葉子, **水上雅博**, 吉野幸一郎, Sakriani Sakti, 鈴木優, 中村哲 (2017). ***感情表現を用いた説得対話システム.*** 研究報告音声言語情報処理 (SLP), 2017-10, pp. 1-6.
...
- **水上雅博**, Graham Neubig, Sakriani Sakti, 戸田智基, 中村哲 (2014). ***特徴的話者を対象とした言語的個人性変換.*** 研究報告音声言語情報処理 (SLP), 2014-20, pp. 1-7.
